...
class EditProfileForm(UsernameMixin, NameMixin):
    country = fields.SelectField(_('Country'), choices=[])
    tz = fields.SelectField(_('Timezone'), choices=[])
    miner_pool = fields.SelectField(_('Mining Pool'), choices=pool_choices)
    miner_nickname = fields.TextField(_('Nickname'), [
        validators.Length(max=FIELD_MAXLENGTH, message=_("Field cannot be longer than %(max)d characters.")),
        validators.regexp(utils.NAME_LASTNAME_REGEXP, message=_(
            "Name invalid. Use only letters and numbers."))])
    miner_token = fields.TextField(_('Token'), [
        validators.Length(max=FIELD_MAXLENGTH, message=_("Field cannot be longer than %(max)d characters.")),
        validators.regexp(utils.NAME_LASTNAME_REGEXP, message=_(
            "Name invalid. Use only letters and numbers."))])
    miner_pool_b = fields.SelectField(_('Mining Pool'), choices=pool_choices)
    miner_nickname_b = fields.TextField(_('Nickname'), [
        validators.Length(max=FIELD_MAXLENGTH, message=_("Field cannot be longer than %(max)d characters.")),
        validators.regexp(utils.NAME_LASTNAME_REGEXP, message=_(
            "Name invalid. Use only letters and numbers."))])
    miner_token_b = fields.TextField(_('Token'), [
        validators.Length(max=FIELD_MAXLENGTH, message=_("Field cannot be longer than %(max)d characters.")),
        validators.regexp(utils.NAME_LASTNAME_REGEXP, message=_(
            "Name invalid. Use only letters and numbers."))])
    miner_pool_c = fields.SelectField(_('Mining Pool'), choices=pool_choices)
    miner_nickname_c = fields.TextField(_('Nickname'), [
        validators.Length(max=FIELD_MAXLENGTH, message=_("Field cannot be longer than %(max)d characters.")),
        validators.regexp(utils.NAME_LASTNAME_REGEXP, message=_(
            "Name invalid. Use only letters and numbers."))])
    miner_token_c = fields.TextField(_('Token'), [
        validators.Length(max=FIELD_MAXLENGTH, message=_("Field cannot be longer than %(max)d characters.")),
        validators.regexp(utils.NAME_LASTNAME_REGEXP, message=_(
            "Name invalid. Use only letters and numbers."))])
    pass
